...
1. [Predict the sale price of houses using Lasso regression](https://github.com/ai-portfolio/ml_model_deployment_pipeline#1-predict-the-sale-price-of-houses-using-lasso-regression)
2. [Differentiate weeds from crop seedlings using a convolutional neural network (CNN)](https://github.com/ai-portfolio/ml_model_deployment_pipeline#2-differentiate-weeds-from-crop-seedlings-using-a-convolutional-neural-network-cnn)
